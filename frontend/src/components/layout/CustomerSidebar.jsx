...
const navItems = [
  ...
  { id: 'place-order', label: 'Place Order', icon: '⊞', path: '/customer/place-order' },
  { id: 'orders', label: 'View All Orders', icon: '▤', path: '/customer/orders' },
  { id: 'payment', label: 'Payment History', icon: '▣', path: '/customer/payment-history' },
]

function CustomerSidebar({ mobileOpen, isMobile = false, onClose = () => {} }) {
      ...
      <div className="d-flex justify-content-between align-items-center mb-5 gap-2">
        <div className="d-flex align-items-center gap-2">
          ...
          <div>
            ...
            <p style={{ margin: 0, fontSize: '0.7rem', color: 'white', letterSpacing: '1px', opacity: 0.9 }}>we deliver in peace</p>
          </div>
        </div>
        <button
          type="button"
